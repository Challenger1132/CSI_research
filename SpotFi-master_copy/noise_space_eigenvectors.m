function En = noise_space_eigenvectors(x)
    ...
    %}
    eigenvalues = diag(eigenvalue_matrix);                            % get all the eigenvalues
    [sorted_eigenv,IndexVector]=sort(eigenvalues, 'ascend');        % sort in descending order and return the index vector
    eigenvectors = eigenvectors(:,IndexVector);
